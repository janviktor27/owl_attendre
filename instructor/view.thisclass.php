                ...
                <div class="col-md-12">
                    <section class="panel">
						...
						<span class="pull-right">
							...
							<button data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i></button>
						</span>
                        </header>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 icheck minimal">
							<div class="checkbox single-row">
								<input name="inpDays[]" type="checkbox"> <label>Monday</label>
							</div>
							<div class="checkbox single-row">
								<input name="inpDays[]" type="checkbox"> <label>Tuesday</label>
							</div>
							<div class="checkbox single-row">
								<input name="inpDays[]" type="checkbox"> <label>Wednesday</label>
							</div>
							<div class="checkbox single-row">
								<input name="inpDays[]" type="checkbox"> <label>Thursday</label>
							</div>
							<div class="checkbox single-row">
								<input name="inpDays[]" type="checkbox"> <label>Friday</label>
							</div>
							<div class="checkbox single-row">
								<input name="inpDays[]" type="checkbox"> <label>Saturday</label>
							</div>
							<div class="checkbox single-row">
								<input name="inpDays[]" type="checkbox"> <label>Sunday</label>
							</div>
						</div>
					</div>
					<div class="form-group">
