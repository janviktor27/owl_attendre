...
//TESTER
$_DAYTODAY = "Thu";
// $_FAKETIME = new DateTime("5:00 pm");
...
//GET LOC FUNCTION
  ...
  //SAMPLE FINANCE
  // $longitude_x = 18.185621;
  // $latitude_y = 120.567213;
  ...
  $_POST['qrcodescanned'] = "Clab 2-Mega";
    ...
    $sched_ids = getSchedIDS($stud_id);
      foreach($sched_ids as $sched_id){
        ...
        if(strpos($sched_days,$_DAYTODAY) !== false){
          echo "<br /><br />START TIME: ".$start_time;
      ...
      if($classcount == 1){//HAS VERIFIED ALL
        ...
        echo "<br />You don't have any class today at this time.";
      }
    else:
  ...
  function getSchedInfo($sched_id){
    ...
    return array ($sched_days,$sched_start_time,$sched_end_time);
  }
  //GET BUILDING ID
